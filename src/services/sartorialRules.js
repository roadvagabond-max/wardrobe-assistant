...
export const SARTORIAL_CATEGORIES = [
  ...
  { id: 'menswear_specific', label: 'Férfi Stílusszabályok', icon: '👔' },
...
export const INITIAL_SARTORIAL_RULES = [
  // 1. Collar & Neckline
  {
    ...
    targetStyles: ['Klasszikus & Időtlen', 'Smart Urban', 'Minimalista'],
    gender: 'universal',
  ...
  },
  {
    ...
    targetStyles: ['Klasszikus & Időtlen', 'Smart Urban', 'Old Money & Quiet Luxury', 'Klasszikus & Nőies Chic'],
    gender: 'universal',
    ageGroups: ['adult', 'teen'],
    severity: 'strict',
  ...
  },
  {
    ...
    targetStyles: ['Klasszikus & Nőies Chic', 'French Chic', 'Minimalista'],
  ...
  },
  {
    ...
    targetStyles: ['Klasszikus & Nőies Chic', 'French Chic', 'Old Money & Quiet Luxury'],
    gender: 'womenswear_specific',
    ageGroups: ['adult'],
    severity: 'strict',
  ...
  },
  {
    ...
    targetStyles: ['Smart Urban', 'Streetwear', 'Minimalista', 'Vintage & Retro'],
    gender: 'universal',
    ageGroups: ['adult', 'teen'],
    severity: 'strict',
  ...
  // 2. Sleeve Hierarchy
  {
    ...
    targetStyles: ['Klasszikus & Időtlen', 'Olasz Sprezzatura', 'Smart Urban'],
    gender: 'universal',
    ageGroups: ['adult', 'teen'],
    severity: 'strict',
  ...
  },
  {
    ...
    targetStyles: ['Klasszikus & Időtlen', 'Old Money & Quiet Luxury', 'Vintage & Retro'],
    gender: 'universal',
    ageGroups: ['adult', 'teen'],
    severity: 'strict',
  ...
  // 3. Silhouette & Volume Balance
  {
    ...
    targetStyles: ['Smart Urban', 'Streetwear', 'Minimalista', 'Klasszikus & Nőies Chic'],
    gender: 'universal',
    ageGroups: ['adult', 'teen'],
    severity: 'high',
  ...
  // 4. Fabric Synergy & Weather Dynamics
  {
    ...
    targetStyles: ['Klasszikus & Időtlen', 'Old Money & Quiet Luxury', 'Smart Urban'],
    gender: 'universal',
    ageGroups: ['adult', 'teen'],
    severity: 'high',
  ...
  },
  {
    ...
    targetStyles: ['Klasszikus & Időtlen', 'Olasz Sprezzatura', 'Old Money & Quiet Luxury', 'French Chic'],
    gender: 'universal',
    ageGroups: ['adult', 'teen'],
    severity: 'strict',
  ...
  },
  {
    ...
    targetStyles: ['Klasszikus & Időtlen', 'Olasz Sprezzatura', 'Smart Urban', 'Minimalista'],
    gender: 'universal',
    ageGroups: ['adult', 'teen'],
    severity: 'high',
  ...
  // 5. Color Harmony & Contrast
  {
    ...
    targetStyles: ['Klasszikus & Időtlen', 'Olasz Sprezzatura', 'Old Money & Quiet Luxury', 'Klasszikus & Nőies Chic', 'Minimalista'],
    gender: 'universal',
    ageGroups: ['adult', 'teen'],
    severity: 'high',
  ...
  // 7. Leather & Metal Coordination
  {
    ...
    targetStyles: ['Klasszikus & Időtlen', 'Olasz Sprezzatura', 'Old Money & Quiet Luxury', 'Klasszikus & Nőies Chic'],
    gender: 'universal',
    ageGroups: ['adult', 'teen'],
    severity: 'strict',
  ...
  // 8. Menswear Finishing Touches & Buttoning Etiquette
  {
  ...
  {
    id: 'rule-lapel-vs-tie-width',
    category: 'menswear_specific',
    title: 'Nyakkendőszélesség és zakóhajtóka geometriai harmóniája',
    ruleDescription: 'A nyakkendő legszélesebb pontjának pontosan követnie kell a zakó hajtókájának legszélesebb pontját. Keskeny hajtókához vékonyabb (6–7 cm), klasszikus és széles hajtókához strukturáltabb (8–9 cm) nyakkendő illik.',
    dont: 'Széles zakóhajtóka + vékony skinny nyakkendő, vagy keskeny hajtóka + vastag retró nyakkendő',
    do: 'A nyakkendő szélessége megegyezik a zakó hajtókájának szélességével',
    targetStyles: ['Klasszikus & Időtlen', 'Olasz Sprezzatura', 'Old Money & Quiet Luxury'],
    gender: 'menswear_specific',
    ageGroups: ['adult'],
    severity: 'high',
    source: 'Alan Flusser: Dressing the Man & Savile Row Standards',
    enabled: true,
    discoveredAt: '2026-09-02T00:00:00.000Z'
  },
  {
    id: 'rule-suspenders-vs-belt',
    category: 'menswear_specific',
    title: 'Nadrágtartó és deréköv összeférhetetlensége',
    ruleDescription: 'Nadrágtartó (hózentróger) és deréköv egyidejű viselése funkcionális és stilisztikai redundancia (kettős tartóelem). Nadrágtartó használata esetén az övbújtatók elhagyandók vagy üresen hagyandók.',
    dont: 'Nadrágtartó + deréköv egyszerre egy nadrágon',
    do: 'Kizárólag nadrágtartó VAGY kizárólag deréköv viselése',
    targetStyles: ['Klasszikus & Időtlen', 'Old Money & Quiet Luxury'],
    gender: 'menswear_specific',
    ageGroups: ['adult'],
    severity: 'strict',
    source: 'British Bespoke Heritage & Savile Row Code',
    enabled: true,
    discoveredAt: '2026-09-02T00:00:00.000Z'
  }
];
...
[
  {
    ...
    "category": "collar_harmony" | "sleeve_hierarchy" | "silhouette_balance" | "fabric_synergy" | "color_and_contrast" | "footwear_and_proportions" | "leather_and_metals" | "finishing_touches" | "menswear_specific" | "womenswear_specific",
